...
from flask_jsglue import JSGlue # this is use for url_for() working inside javascript which is help navigate the url
import util
import os
...
# JSGlue is use for url_for() working inside javascript which  help to navigate the url
